...
func must_parse(s string) int {
	size, err := ParseHumanReadableSize(s)
	if err != nil {
...
func BenchmarkRecursiveDacCgoMemcpyDepth1Size1mb(b *testing.B) {
	B_WrapperN(RecursiveDacCgoMemcpy, "1mb", 1, b)
}
func BenchmarkRecursiveDacCgoMemcpyDepth2Size1mb(b *testing.B) {
	B_WrapperN(RecursiveDacCgoMemcpy, "1mb", 2, b)
}
func BenchmarkRecursiveDacCgoMemcpyDepth3Size1mb(b *testing.B) {
	B_WrapperN(RecursiveDacCgoMemcpy, "1mb", 3, b)
}
...
func BenchmarkPartitionedCgoMemcpyParts2Size1mb(b *testing.B) {
	B_WrapperN(PartitionedCgoMemcpy, "1mb", 2, b)
}
func BenchmarkPartitionedCgoMemcpyParts4Size1mb(b *testing.B) {
	B_WrapperN(PartitionedCgoMemcpy, "1mb", 4, b)
}
func BenchmarkPartitionedCgoMemcpyParts8Size1mb(b *testing.B) {
	B_WrapperN(PartitionedCgoMemcpy, "1mb", 8, b)
}
